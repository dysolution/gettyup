...
# 1. Create a batch.
# 2. Create and then update and delete a contribution, using the "last" command.
# 3. Delete the batch when finished.
...
# 1. Create a batch.
# 2. Create and submit a contribution, using "last" to submit the correct one.
# 3. This batch can't be deleted because it will contain a submitted contribution.
...
# 1. Get, create, and delete a release.
# 2. List releases for the given batch.
GCV_BATCH=89823
